...
The **0.76.0** home-assistant image built with the dev version of **python_openzwave 0.4.9**.  This was done specifically to get my GoControl/Linear GD00Z-4 working with home-assistant.
